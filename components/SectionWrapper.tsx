  ...
  return (
    <div className="relative w-full h-full overflow-hidden flex flex-col lg:flex-row">
      ...
      <div className="w-full lg:w-1/2 h-full overflow-y-auto bg-[#061125] scrollbar-hide relative z-10 animate-fade-in">
        <div className="px-8 py-24 lg:px-20 lg:py-32 min-h-full flex flex-col">
           ...
           <div className="flex-1 opacity-0 animate-fade-in delay-500" style={{ animationFillMode: 'forwards' }}>
             {children}
           </div>

           {/* Added Footer here */}
           <div className="opacity-0 animate-fade-in delay-700" style={{ animationFillMode: 'forwards' }}>
            <Footer />
           </div>
        </div>
      </div>
